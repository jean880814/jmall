package com.jmall.user.kafkaConfig;

import com.jmall.user.registerVerification.KafKaRegisterSuccConsumerFactory;
import com.jmall.user.registerVerification.KafKaRegisterSuccProducerFactory;
...
public class KafKaConfig {
    ...
    public KafKaRegisterSuccConsumerFactory kafKaRegisterSuccConsumerFactory(){
        ...
        consumerProperties.put("spring.json.trusted.packages" ,"com.jmall.user.dal.entitys,com.jmall.user.dal.*");
        /*
