package com.jmall.commons.lock.extension;

import com.jmall.commons.lock.extension.annotation.LockSpi;
                                    ...
                                    try {
                                        ...
                                        if (line.length() > 0) {
                                            ...
                                            try {
                                                ...
                                                //name 按都逗号分隔，可以配置多个
                                                //如：redis,redis_1=com.jmall.commons.lock.impl.DistributedRedisLock
