package com.jmall.commons.lock.aspect;

import com.jmall.commons.lock.DistributedLock;
import com.jmall.commons.lock.annotation.CustomerLock;
import com.jmall.commons.lock.extension.ExtensionLoader;
...
public class DistributedLockAspect {
    ...
    //切入点：有这个注解的方法
    @Pointcut("@annotation(com.jmall.commons.lock.annotation.CustomerLock)")
    ...
    private Object startLock(final String lockKey, ProceedingJoinPoint pjp, Method method) throws Throwable {
        CustomerLock annotation = method.getAnnotation(CustomerLock.class);
         //是否尝试获得锁 com.jmall.commons.lock.annotation.CustomerLock.tryLock
