...
import com.jmall.shopping.ICartService;
import com.jmall.shopping.dto.ClearCartItemRequest;
import com.jmall.shopping.dto.ClearCartItemResponse;
...
public class ClearCartItemHandler extends AbstractTransHandler {
    @Reference(check = false,mock = "com.jmall.order.biz.mock.MockCartService")
